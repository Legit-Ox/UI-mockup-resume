...
class MobileBody extends StatefulWidget {
  const MobileBody({Key? key, required this.myInfo}) : super(key: key);
                  ...
                  children: [
                    Text.rich(TextSpan(
                        ...
                        style: GoogleFonts.poppins(
                            fontSize: 18,
                            color: const Color.fromARGB(255, 166, 163, 166)),
              ...
              Center(
                child: GreyBox(
                  ...
                  child: const Row(
                    ...
                    children: [
                      SocialIcon(
                          onHoverBackground: Color.fromARGB(255, 40, 105, 179),
                          icon: 'assets/icons/linkedin.svg'),
                      SocialIcon(
                          onHoverBackground: Color.fromARGB(255, 251, 89, 124),
                          icon: 'assets/icons/dribble.svg'),
                      SocialIcon(
                          onHoverBackground: Color.fromARGB(255, 3, 169, 245),
                          icon: 'assets/icons/twitter.svg'),
                      SocialIcon(
                          onHoverBackground: Color.fromARGB(255, 186, 51, 143),
